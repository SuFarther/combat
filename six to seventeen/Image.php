<?php
   ...
   $image = new Image();
//   $image->water('timg.jpeg','xiaochou.gif',0);
   $image -> scale('timg.jpeg',300,300);
   class Image{
      ...
      function  water($image,$water,$position,$alpha = 100,$prefix='water_')
      {
          ...
          //6.将水印图片贴过来
          imagecopymerge($imageRes,$waterRes,$pos['x'],$pos['y'],0,0,$waterInfo['width'],
          $waterInfo['height'],$alpha);
          //7.得到要保存图片的文件名
       ...
       //$height:缩放后的高度
       //$prefix:前缀
       function scale($image,$width,$height,$prefix='sf_'){
      ...
      protected  function  createNewName($imagePath,$prefix){
          ...
          if($this -> isRandName){
              ...
              $name = $prefix.pathinfo($imagePath)['file_name'].'.'.$this->type;
          }
          return $name;
      }
