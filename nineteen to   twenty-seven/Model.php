...
//  var_dump($insertId);
//  $m ->limit('0,5')->where('id>1')->table('user')->field('age,name')->order('money desc')
//      ->select();
//  var_dump($m->sql);
...
//          die();
      ...
      //传递进来一个数组,经数组汇中值为字符串的两边加上引号
      protected  function  parseValue($data){
          //遍历数组,判断是否是字符串,若是字符串,将其两边添加引号
